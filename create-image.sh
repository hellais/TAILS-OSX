...
set -x
TAILS_ISO_URL="http://dl.amnesia.boum.org/tails/stable/tails-i386-0.22/tails-i386-0.22.iso"
TAILS_SIG_URL="https://tails.boum.org/torrents/files/tails-i386-0.22.iso.sig"
